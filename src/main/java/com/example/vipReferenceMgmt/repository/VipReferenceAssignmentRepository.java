...
public interface VipReferenceAssignmentRepository extends JpaRepository<VipReferenceAssignment, Long>{
	...
	List<VipReferenceAssignment> findByToLogin_LoginIdAndToRole_RoleNameAndStatus(String loginId, String queueName,ReferenceStatus status);

	Optional<VipReferenceAssignment> findByToLogin_LoginIdAndStatusAndVipReference_ReferenceId(
		    String toLoginId,
